...
public class AdminDashboard extends Stage{
    ...
    public AdminDashboard() throws IOException {
        ...
        Parent creteAccountsRoot = CreateAccountsLoader.load();     
        AccountCreation = new Scene(creteAccountsRoot);
